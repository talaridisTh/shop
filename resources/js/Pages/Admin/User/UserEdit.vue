<template>
   ...
   <form class="flex flex-col">
	  ...
	  <div class="flex justify-between items-center">
		 <Title>Edit User ({{form.name}})</Title>
		 <ResponsiveNavLink as="button" :disabled="form.processing" @click="onSubmit">Update</ResponsiveNavLink>
	  </div>
...
const onSubmit = () => {
   form.put(route('user.update', props.user.slug));
}
